...
(function () {
  ...
  const index = [
    ...
    { title: 'Easy tutorials', sub: 'Bare motor drivetrain, bearing stack', url: 'tutorials.html#easy' },
    { title: 'Medium tutorials', sub: 'Parallel plate drivetrain, claw, active intake', url: 'tutorials.html#medium' },
    { title: 'Hard tutorials', sub: 'Coaxial 4-bar diff arm, shooter', url: 'tutorials.html#hard' },
    { title: 'Bare motor drivetrain', sub: 'Tutorial · Easy', url: 'tutorials.html#easy' },
    { title: 'Bearing Stack', sub: 'Tutorial · Easy', url: 'tutorials.html#easy' },
    { title: 'Parallel Plate Drivetrain', sub: 'Tutorial · Medium', url: 'tutorials.html#medium' },
    { title: 'Claw', sub: 'Tutorial · Medium', url: 'tutorials.html#medium' },
    ...
    { title: 'Shooter', sub: 'Tutorial · Hard', url: 'tutorials.html#hard' },
    ...
    { title: 'Intakes', sub: 'Active, pivoting, under-bumper', url: 'mechanisms.html#intakes' },
